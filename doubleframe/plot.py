...
data["rx"] = data[column_name] * 0.250 / 1200
data2["rx"] = data2[column_name] * 0.250 / 1200
data3["rx"] = data3[column_name] * 0.250 / 1200
data4["rx"] = data4[column_name] * 0.250 / 1200
data5["rx"] = data5[column_name] * 0.250 / 1200
data6["rx"] = data6[column_name] * 0.250 / 1200
data7["rx"] = data7[column_name] * 0.250 / 1200
# Extract data from the specified column
throughput_data = data[column_name]
throughput_data2= data2[column_name]
throughput_data3= data3[column_name]
throughput_data4= data4[column_name]
throughput_data5= data5[column_name]
throughput_data6= data6[column_name]
throughput_data7= data7[column_name]
...
# Display the plot
plt.savefig(f"32byte_DeviceThroughput.pdf")
