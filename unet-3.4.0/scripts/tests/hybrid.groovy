...
for ( i = 3; i<13; i++){
    ...
    simulate 20.minutes, {
      ...
      cont.startup = {
           ...
           for(p in pay){
              link << new DatagramReq(to:0,data:p,shortcircuit:false,protocol:33)
    ...
    [trace.txCount, trace.rxCount, (txcount+ctrtxcount)*0.250 / 1200 , (rxcount+ctrrxcount)*0.250 /1200,txcount,rxcount,ctrtxcount,ctrrxcount])
